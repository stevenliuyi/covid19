...
# crawl data
crawlers="iran-data chile-data india-data japan-data croatia-data hungary-data denmark-data slovakia-data hong-kong-data algeria-data morocco-data sri-lanka-data"

...
export const BOLIVIA_ZH = '玻利维亚'
export const HONDURAS_ZH = '洪都拉斯'
export const TURKEY_ZH = '土耳其'
export const SRI_LANKA_ZH = '斯里兰卡'
export const NEPAL_ZH = '尼泊尔'
export const GUATEMALA_ZH = '危地马拉'

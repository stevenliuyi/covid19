...
# download maps
gadm_maps="CHN HKG MAC TWN KOR ITA FRA DEU JPN AUT AUS USA CAN ESP CHE GBR SWE POL NOR IRN PRT BRA MYS CHL BEL CZE"
...
./node_modules/mapshaper/bin/mapshaper ./data/maps/gadm36_CZE_1.shp -simplify 10% -clean -o format=topojson ./public/maps/gadm36_CZE_1.json
...
./node_modules/mapshaper/bin/mapshaper ./data/maps/italy_provinces.json -simplify 10% -clean -o format=topojson ./public/maps/italy_provinces.json
...
data_processing_filenames="world_current world china china_overall world_dxy korea italy us us_1p3a france germany japan austria australia canada spain switzerland uk netherlands sweden poland norway iran portugal brazil malaysia chile belgium czechia"

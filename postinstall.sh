...
# download maps
gadm_maps="CHN HKG MAC TWN KOR ITA FRA DEU JPN AUT AUS USA CAN ESP CHE GBR SWE POL"
...
data_processing_filenames="world_current world china korea italy us us_1p3a france germany japan austria australia canada spain switzerland uk netherlands sweden poland"
